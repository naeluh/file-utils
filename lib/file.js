...
// Copy a file and process it's content as underscore template
File.prototype.copyTemplate = function(srcpath, destpath, context, options) {
  if (!options) options = {};

  _.extend(options, {
      process: function (contents) {
        return _.template(contents)(context, options.templateSettings);
      }
  });

  this.copy(srcpath, destpath, options);
};
